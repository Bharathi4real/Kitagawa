...
import Marin.Database.welcome_sql as sql
from Marin import (
    DEV_USERS,
    LOGGER,
    OWNER_ID,
...
from Marin.Handlers.msg_types import get_welcome_type
from Marin.Handlers.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from Marin.Plugins.Admin.log_channel import loggable
from Marin.Database.global_bans_sql import is_user_gbanned
